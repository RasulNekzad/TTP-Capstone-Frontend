    ...
    return (
        <>
            ...
            <div className="header--2">
                <div className="header__col--4">
                    <div className="header__text">
                        <span style={{paddingBottom: "5rem"}}>Discover Through Music</span>
                        <h5>
                            <br/>
                            Embark on a journey of harmonious connections as <br/>Spotify Proximity brings you closer to
                            fellow
                            music enthusiasts,
                            <br/>celebrating the beauty of diverse tastes and shared rhythms.
                        </h5>
                    </div>
                </div>
            ...
            <div className="main__container">
                <div className="main__text"><h1>How It Works</h1></div>
                <div className="main__col--5">
                    <div className="main__card">
                        <h1 className="main__card__num">1</h1>
                        <img className="main__img" src={spotify_2} alt="spotify icon"/>
                        <span>Sign up and then connect your Spotify account to our app, which would allow you to share your
                            music with your community.</span>
                    </div>
                    <div className="main__card">
                        <h1 className="main__card__num">2</h1>
                        <img className="main__img" src={mapLocation} alt="map location icon"/>
                        <span>Explore our interactive map, offering a unique glimpse into the musical preferences of people nearby.</span>
                    </div>
                    <div className="main__card">
                        <h1 className="main__card__num">3</h1>
                        <img className="main__img" src={musicalNote} alt="musical note icon"/>
                        <span>Click on the music icon to view song information and listen to a 30 second preview.</span>
                    </div>
                </div>
            </div>
